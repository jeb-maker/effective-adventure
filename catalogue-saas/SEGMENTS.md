...
Généré depuis `taxonomy.json` — **68 segments**.
...
| ID | Label | Vendeurs |
|---|---|---:|
| `cybersecurity-platforms` | Cybersécurité (SIEM/XDR/SOAR) | 5 |
| `identity-access-management` | IAM & accès | 5 |
| `cloud-security-cspm` | Cloud security & CSPM | 5 |
| `email-security` | Email security | 5 |
| `vulnerability-management` | Vulnérabilités & exposition | 5 |
...
| ID | Label | Vendeurs |
|---|---|---:|
| `healthcare-clinical-ai` | Santé clinique IA | 5 |
| `health-data-analytics` | Analytics santé & medtech | 5 |

## Vertical — Industrie

| ID | Label | Vendeurs |
|---|---|---:|
| `real-estate-proptech` | Immobilier & proptech | 5 |
| `insurance-insurtech` | Assurance & insurtech | 5 |
| `construction-proptech` | Construction & BIM | 5 |
| `supply-chain-logistics` | Supply chain & logistique | 5 |
| `retail-ecommerce-ai` | Retail & e-commerce IA | 5 |
| `energy-cleantech` | Énergie & cleantech | 5 |
